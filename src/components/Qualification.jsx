      ...
      <div className="qualification-container">
        ...
        <div className="qualification-item" data-aos="fade-up" data-aos-delay="300">
          <div className="qualification-content">
            ...
            <p><strong>University:</strong> Dr. Bhimrao Ambedkar University, Agra, India</p>
            <p><strong>Graduation Year:</strong> 2021 – 2025</p>
            <p><strong>Key Subjects:</strong> Data Structures & Algorithms | Oops using Java | DBMS | Operating System| Artificial Intelligence | Software Engineering | Web Development</p>
            <p><strong>Location:</strong> Agra, UP, India</p>
          </div>
        </div>
      </div>
    </section>
